...
var quotes = [
	...
	"There are two kinds of chairs to go with two kinds of Minister: one sort folds up instantly; the other sort goes round and round in circles.",
...
function tweet() {
	...
	context.fillRect(0, (twitterPadding * 3), twitterWidth, twitterHeight);

	// Add text
	context.textBaseline="top";
	context.font = "normal " +twitterLineHeight+  "px 'Helvetica Neue', Arial, sans-serif";
	context.fillStyle = "#ffffff"
	...
	context.drawImage(img, twitterPadding, (twitterPadding * 0.8), img.width / 3, img.height / 3)
